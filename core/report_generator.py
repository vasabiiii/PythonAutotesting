...
def generate_pdf_report_single(test_name, result, details, screenshot_path=None):
    ...
    action_paragraph = Paragraph(details, styles['Normal'])  # Wrap text in Action column
    data.append([str(1), action_paragraph, result, screenshot])

    column_widths = [50, 200, 100, 150]
